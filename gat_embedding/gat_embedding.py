...
def main():
    ...
    ## 1208x128, 256x128 mismatch
    parser.add_argument('--in_feats', type=int, default=128, help='Number of input features.')
    parser.add_argument('--out_feats', type=int, default=256, help='Number of output features.')
...
## gnn_pathways % python _gat_src_miRNA_hmdd/gat_embedding.py --out_feats 128 --num_layers 2 --num_heads 2 --batch_size 1 --lr 0.0001 --num_epochs 108
## gnn_pathways % python gat_src_miRNA_db/gat_embedding.py --out_feats 256 --num_layers 2 --num_heads 2 --batch_size 1 --lr 0.0001 --num_epochs 1000
## python gat/gat_embedding.py --out_feats 128 --num_layers 3 --num_heads 2 --batch_size 1 --lr 0.0001 --num_epochs 2002
## python gat/gat_embedding.py --out_feats 256 --num_layers 2 --num_heads 2 --batch_size 1 --lr 0.0001 --num_epochs 1002